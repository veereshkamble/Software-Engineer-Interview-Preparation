...
public class BinaryTreeFromInPreIterative {
    ...
    public static void main(String[] args) {
        ...
        BinaryTreeFromInPreIterative binaryTreeFromInPreIterative = new BinaryTreeFromInPreIterative();
        System.out.println(binaryTreeFromInPreIterative.buildTree(inorder, postorder));
    }
}
